  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="订单ID" prop="checkOrderId">
        <el-input
          v-model="queryParams.checkOrderId"
          placeholder="请输入订单ID"
          clearable
      ...
      <el-form-item label="收款金额" prop="checkRevAmt">
        <el-input
          v-model="queryParams.checkRevAmt"
          placeholder="请输入收款金额"
          clearable
          @keyup.enter.native="handleQuery"
        />
      ...
      <el-form-item label="收款人" prop="checkHolderUserId">
        <el-input
          v-model="queryParams.checkHolderUserId"
          placeholder="请输入收款人"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="checkList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单ID" align="center" prop="checkOrderId" />
      ...
      <el-table-column label="收款人" align="center" prop="checkHolderUserId" />
